...
import { Heart, MessageCircle, Zap, Bell, UserPlus, ArrowRight, ArrowLeft } from "lucide-react";
...
export default function NotificationsPage() {
  ...
  useEffect(() => {
    async function fetchNotifs() {
      try {
        ...
        if (!user) return; // Loading será removido no finally
  ...
  return (
    <Shell user={currentUser}>
       {/* pt-20: Garante que o conteúdo desça no mobile (por causa do header fixo da Sidebar)
          lg:pt-8: No desktop, o header não é fixo em cima, então o padding é menor 
       */}
       <div className="max-w-2xl mx-auto min-h-screen pb-32 px-4 lg:px-0 pt-20 lg:pt-8">
          ...
          <div className="flex items-center gap-3 mb-6">
              <div className="lg:hidden">
                 {/* Espaço reservado se precisar de botão voltar mobile extra */}
              </div>
          ...
          {/* Abas Estáticas (Para não sobrepor nada) */}
